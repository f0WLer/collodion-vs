...
namespace Photocore.Plates
{
    ...
    public static class PlateDryingTransition
    {
        ...
        public static void ResetTimer(IWorldAccessor world, ItemStack stack, double freshHoursOverride)
        {
            ...
            attr["freshHours"] = new FloatArrayAttribute([(float)freshHoursOverride]);
            attr["transitionHours"] = new FloatArrayAttribute([0.001f]);
            attr["transitionedHours"] = new FloatArrayAttribute([0f]);
