...
namespace Photochemistry.ImageEffects
{
    public static partial class ImageEffects
    {
        ...
        // softer toward edges and corners. The curve here is tuned to the collodion wet-plate look.
        //
        // Applied after MicroBlur, before grain.
        private static void ApplyLensAberration(SKBitmap bmp, ImageEffectsConfig cfg)
        {
