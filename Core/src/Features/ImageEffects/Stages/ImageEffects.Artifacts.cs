...
namespace Photocore.ImageEffects
{
    public static partial class ImageEffects
    {
        ...
        private static void DrawScratches(SKCanvas canvas, int w, int h, Random rng, ImageEffectsConfig cfg)
        {
        ...
        private static void SampleEdgeBiasedPoint(int w, int h, Random rng, ImageEffectsConfig cfg, out float x, out float y)
        {
