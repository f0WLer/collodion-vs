...
namespace Collodion.CameraCapture
{
    ...
    internal sealed class VirtualCamera
    {
        ...
        internal void RenderCamera(float dt)
        {
            ...
            bool savedBlockOutline = ClientSettings.SelectedBlockOutline;
            ClientSettings.SelectedBlockOutline = false;
            ViewportExposureSuppressContext.IsVirtualRender = true;
            ...
            try
            {
                ...
                GL.ClipPlane(ClipPlaneName.ClipDistance0, [0d, 1d, 0d, 5d]);
            ...
            finally
            {
                ...
                ClientSettings.SelectedBlockOutline = savedBlockOutline;
                ViewportExposureSuppressContext.IsVirtualRender = false;
            }
        }
