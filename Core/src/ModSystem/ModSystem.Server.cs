...
namespace Photocore
{
    ...
    public partial class PhotocoreModSystem
    {
        ...
        public override void StartServerSide(ICoreServerAPI api)
        {
            ...
            // Config, so it needs its own reload when the ConfigLib or IMM GUI saves photocore.json.
            // Safe whether or not either mod is installed.
            Configuration.ExternalConfigIntegration.RegisterServer(api, this);
        }
    }
}