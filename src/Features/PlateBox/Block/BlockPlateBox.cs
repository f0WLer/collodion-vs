...
namespace Collodion.PlateBox
{
    ...
    {
        private static readonly AssetLocation _samplePlateCode = new("collodion", "sensitizedplate");
        private static readonly AssetLocation _closedBoxCode = new("collodion", "platebox-north");
        ...
        private static readonly AssetLocation _woodThudSound = new("collodion", "sounds/wood-thud");
